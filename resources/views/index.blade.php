...
<body>
  ...
  <div class="container my-5">
    ...
    <div class="row">
      <div class="col-md-4">
        <div class="card">
          <img src="/images/1.jpg" class="card-img-top" alt="Food Item 1">
          <div class="card-body">
      ...
      <div class="col-md-4">
        <div class="card">
          <img src="/images/2.jpg" class="card-img-top" alt="Food Item 2">
          <div class="card-body">
      ...
      <div class="col-md-4">
        <div class="card">
          <img src="/images/3.jpg" class="card-img-top" alt="Food Item 3">
          <div class="card-body">
