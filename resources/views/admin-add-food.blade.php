        ...
        <div class="row">
            ...
            <main class="col-md-10 ms-sm-auto col-lg-10 px-md-4">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h1 class="h2 text-primary">Add Food Items</h1>
                </div>

                <section id="add-food" class="mt-5">
                    <h3 class="mb-4">Add New Food Item</h3>
                    <form method="POST" action="/admin/add-food" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-3">
                            <label for="foodName" class="form-label">Food Name</label>
                            <input type="text" class="form-control" name="name" id="foodName" placeholder="Enter food name">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" name="price" id="foodPrice" placeholder="Enter price">
                        </div>
                        <div class="mb-3">
